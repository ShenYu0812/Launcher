...
import static com.jiuzhou.porter.launcher.until.Constant.nameGroup4;
import static com.jiuzhou.porter.launcher.until.Constant.resId4;
...
public class ChineseActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int i=0;i<20;i++) {
            ...
            bean.setIcon(resId4[i%10]);
            bean.setName(nameGroup4[i%10]);
            bean.setPath("path null");
            mList.add(bean);
        }
        BookRecyclerAdapter adapter = new BookRecyclerAdapter(this, mList, "M3");
