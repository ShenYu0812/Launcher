...
import static com.jiuzhou.porter.launcher.until.Constant.nameGroup6;
import static com.jiuzhou.porter.launcher.until.Constant.resId6;
...
public class ScienceActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        view.setBackgroundResource(R.mipmap.module_pic_background);
        ...
        for (int i=0;i<6;i++) {
            ...
            bean.setIcon(resId6[i]);
            bean.setName(nameGroup6[i]);
            bean.setPath("path null");
            mList.add(bean);
        }
        BookRecyclerAdapter adapter = new BookRecyclerAdapter(this, mList, "M5");
        mRecyclerView.setItemAnimator(new DefaultItemAnimator());
        mRecyclerView.setAdapter(adapter);

        GridLayoutManager gridLayoutManager = new GridLayoutManager(this, 3);
        mRecyclerView.setLayoutManager(gridLayoutManager);
        int right = (int) getResources().getDimension(R.dimen.px_positive_100);
        int bottom = (int) getResources().getDimension(R.dimen.px_positive_40);
