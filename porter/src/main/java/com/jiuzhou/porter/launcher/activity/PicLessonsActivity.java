...
public class PicLessonsActivity extends Activity {
    private static final String TAG = PicLessonsActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BookRecyclerAdapter adapter = new BookRecyclerAdapter(this, mList, "M1");
