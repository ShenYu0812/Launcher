...
public class PicEnjoyActivity extends FragmentActivity implements OpenTabHost.OnTabSelectListener,
        ViewPager.OnPageChangeListener, DetailFragment.OnFragmentInteractionListener {
    private static final String TAG = PicEnjoyActivity.class.getSimpleName();
    ...
    private void onInit() {
        ...
        for (int i=0;i<page;i++) {
            mListOfFragments.add(DetailFragment.newInstance("M2"));
        }
    ...
    private List<String> getData() {
        ...
        String[] array = getResources().getStringArray(R.array.detailCategory);
