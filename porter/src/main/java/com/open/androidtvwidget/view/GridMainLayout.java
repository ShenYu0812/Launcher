...
public class GridMainLayout extends GridLayout {

    public GridMainLayout(Context context) {
        super(context);
        init(context);
    }

    public GridMainLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public GridMainLayout(Context context, AttributeSet attrs, int defStyleAttr) {
