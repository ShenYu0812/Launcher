...
public class ReflectLayout extends FrameLayout {
    private static final String TAG = ReflectLayout.class.getSimpleName();
    ...
    public ReflectLayout(Context context, AttributeSet attrs, int defStyle) {
